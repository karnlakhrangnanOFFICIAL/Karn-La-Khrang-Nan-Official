...
| :--- | :--- |
| **`data/fixtures-men.json`** | ไฟล์หลักสำหรับเก็บตารางการแข่งขันและรายละเอียดแมตช์ (รวมถึงรายชื่อผู้ทำประตู `goals`) |
...
| **`assets/images/players/`** | โฟลเดอร์เก็บรูปภาพโปรไฟล์นักเตะ (`.jpg` / `.png`) |

*(หมายเหตุ: สำหรับทีมหญิง ให้ดำเนินการในลักษณะเดียวกันกับไฟล์ `fixtures-women.json`, `results-women.json` และ `players-women.json`)*

---

## ⚽ 2. ขั้นตอนการอัปเดตหลังจบเกม (Post-Match Update Steps)

### **ขั้นตอนที่ 1: อัปเดตแมตช์ใน `data/fixtures-men.json`**
...
#### 💡 ตัวอย่างการลงข้อมูลใน `fixtures-men.json`:
...
```json
{
  ...
  "competition_logo": "",
  "home_team": "Chelsea",
  "home_logo": "databases/logo/teams/england_chelsea.football-logos.cc.svg",
  "away_team": "Tottenham Hotspur",
  "away_logo": "databases/logo/teams/england_tottenham--2006-2013.football-logos.cc.svg",
  "venue": "Accor Stadium",
  "home_score": 1,
  "away_score": 2,
  "status": "completed",
...
1. **บันทึกรูปภาพ**: นำรูปถ่ายของนักเตะไปวางไว้ที่ `assets/images/players/` (เช่น `dastan-satpaev.png`)
2. **เพิ่มข้อมูลโปรไฟล์นักเตะ**: เพิ่มก้อนข้อมูลนักเตะใน `data/players-men.json`
...
```json
{
  ...
  "image": "assets/images/players/dastan-satpaev.png",
  "appearances": 1,
  "goals": 1,
  "assists": 0
}
...
> หน้าแสดงผลรายละเอียดแมตช์ (`match-detail.html`) มีระบบแมปชื่ออัจฉริยะ จะทำการค้นหารูปภาพจาก `data/players-men.json` และไฟล์ใน `assets/images/players/` ให้อัตโนมัติ โดยจับคู่จากชื่อหรือนามสกุลนักเตะ
